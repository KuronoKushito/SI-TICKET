...
<head>
	...
	<script>
		WebFont.load({
			...
			custom: {"families":["Flaticon", "Font Awesome 5 Solid", "Font Awesome 5 Regular", "Font Awesome 5 Brands"], urls: ['back-end/assets/css/fonts.css']},
			active: function() {
		...
		<div class="main-header" data-background-color="purple">
			...
			<div class="logo-header">
				...
				<a href="index.html" class="logo">
					<img src="back-end/assets/img/logoazzara.svg" alt="navbar brand" class="navbar-brand">
				</a>
					...
					<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
						...
						<li class="nav-item dropdown hidden-caret">
							...
							<ul class="dropdown-menu dropdown-user animated fadeIn">
								<li>
									<div class="user-box">
										<div class="avatar-lg"><img src="back-end/assets/img/profile.jpg" alt="image profile" class="avatar-img rounded"></div>
										<div class="u-text">
											<h4>Hizrian</h4>
